...
/**
 * ESTA CLASSE FOI ATUALIZADA para corresponder ao bd_lojasocial.sql
 */
...
/**
 * Objeto usado para CRIAR (POST) ou ATUALIZAR (PUT) um beneficiário
 */
data class BeneficiarioRequest(
    ...
    @SerializedName("telefone") val telefone: String?,
    @SerializedName("notas_adicionais") val notasAdicionais: String?,
    @SerializedName("estado") val estado: String? // 'estado' só é usado no PUT
)

/**
 * Resposta da API após criar (POST) ou atualizar (PUT) um beneficiário
 */
...
data class AddStockRequest(
    ...
    @SerializedName("data_validade") val dataValidade: String?, // Formato "YYYY-MM-DD"
    @SerializedName("campanha_id") val campanhaId: String? // UUID
)
...
data class Entrega(
    ...
    @SerializedName("estado") val estado: String, // "agendada", "entregue"
...
data class AgendarEntregaRequest(
    ...
    @SerializedName("data_agendamento") val dataAgendamento: String, // "YYYY-MM-DD"
...
data class EntregaConcluidaData(
    @SerializedName("id") val id: String,
    @SerializedName("estado") val estado: String // "entregue"
)